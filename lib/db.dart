...
class PastEntry {
  ...
  PastEntry.fromJson(Map<String, dynamic> json) : day = json['past_day'] {
    if (json['num_glasses_of_water'] != null) {
...
class MealModel extends ChangeNotifier {
  ...
  MealModel() {
    ...
    dbp.then(getLastSevenDays).then((days) {
      lastSevenDays = days;
    });
  }
  DiaryEntry entry;
